...
if ~isempty(find_system(subsystem, 'SearchDepth', 1, 'Name', 'Gain_puissance_clim'))
    ...
    % Add 0.5 to the signal for display adjustment
    add_block('simulink/Math Operations/Sum', [modelName '/Add_0_5_to_Power'], ...
        'Inputs', '++', 'Position', [660 200 690 230]);
    add_block('simulink/Sources/Constant', [modelName '/Constant_0_5'], ...
        'Value', '0.5', 'Position', [600 200 630 230]);
    safeAddLine(modelName,'Control_Mode_Switch/1','Add_0_5_to_Power/1');
    safeAddLine(modelName,'Constant_0_5/1','Add_0_5_to_Power/2');
    safeAddLine(modelName,'Add_0_5_to_Power/1','ToWs_Applied_Control_Power/1'); % Connect adjusted signal to Scope
